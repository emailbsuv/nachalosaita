...
UninstallDisplayIcon={app}\Началосайта.exe
...
[Files]
Source: "Началосайта.exe"; DestDir: "{app}"
...
[Icons]
Name: "{group}\{cm:MyAppName}"; Filename: "{app}\Началосайта.exe"
Name: "{group}\{cm:UninstallProgram,{cm:MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Началосайта"; Filename: "{app}\Началосайта.exe"; IconFilename: "{app}\Nachalosaita.ico"
; или так
...
[Run]
Filename: "{app}\Началосайта.exe"; Parameters: "/x";
